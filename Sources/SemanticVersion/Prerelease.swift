...
extension SemanticVersion.Prerelease {
	...
	///	- Throws: A `SemanticVersionError` instance if `dotSeparatedIdentifiers` is not a valid pre-release string.
	...
	///	- Throws: A `SemanticVersionError` instance if any element of `identifiers` is not a valid pre-release identifier string.
...
extension SemanticVersion.Prerelease.Identifier {
	...
	///	- Throws: A `SemanticVersionError` instance if `identifierString` is not a valid pre-release identifier string.
...
extension SemanticVersion.Prerelease: Comparable {
...
//	Compiler synthesised `Equatable`-conformance is correct here.
extension SemanticVersion.Prerelease.Identifier: Comparable {
	internal static func <(lhs: Self, rhs: Self) -> Bool {
		switch (lhs, rhs) {
...
extension SemanticVersion.Prerelease: CustomStringConvertible {
...
extension SemanticVersion.Prerelease.Identifier: CustomStringConvertible {
